...
int main()
{
    ...
    nanolog::initialize(nanolog::GuaranteedLogger(), "C:\\Users\\luoch\\software\\clion-workspace\\test1\\", "nanolog", 1);
    ...
    // 这里只有 LogLevel >= LogLevel::CRIT 的日志会输出到文件
    nanolog::set_log_level(nanolog::LogLevel::CRIT);
    LOG_WARN << "This log line will not be logged since we are at loglevel = WARN";
